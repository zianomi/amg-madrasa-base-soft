            ...
            <td valign="top">
                <table style="width:100% !important">
                    <tr style="border:none !important;">
                        ...
                        <td style="border:none !important; width: 60%; text-align: center; font-size: 35px;">امتحانی نمبرات کا گوشوارہ برائے طلباء/طالبات  <?php if(isset($_GET['class']))  echo $tool->GetExplodedVar($_GET['class']) ?> </td>
    ...
    <td valign="top" style="text-align: justify">
        <table style="width:100% !important;" class="tables">
            ...
            <tr>
                ...
                <td style="text-align: center; vertical-align: middle;">درجہ کامیابی</td>
                <td style="text-align: center; vertical-align: middle;">پوزیشن</td>
            ...
            <tr style="background-color: #f7f7f7">
                ...
                <td style="text-align: center; font-family: Arial; font-size: 15px;"><?php //echo $totalSubjectNumbers ?></td>
                <td style="text-align: center; font-family: Arial; font-size: 15px;"></td>
                <td style="text-align: center; font-family: Arial; font-size: 15px;"></td>
                ...
                foreach($rows as $row){
                    ...
                    <tr style="height: 40px;">
                        ...
                        foreach($subjects as $sub){
                            ...
                            ?>
                            <td style="min-width: 20px; overflow: hidden; text-align: center; vertical-align: middle">&nbsp;</td>
                        <?php } ?>
