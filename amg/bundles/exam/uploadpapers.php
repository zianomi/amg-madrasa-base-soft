                    ...
                    <div class="span<?php echo $colSize ?>">
                        <table class="table table-bordered table-striped">
                            ...
                            foreach ($res as $row){
                                ...
                                <?php if($tpl->isCanDelete()){ ?>
                                    <td><a onclick="return confirm('Are you sure you want to delete?');" href="<?php echo Tools::makeLink("exam","uploadpapers&del=1&id=".$row['id']."&redir=".$curPageUrl,"","") ?>"><i class="icon-remove"></i></a> </td>
                                <?php } ?>
                                </tr>
                            <?php } ?>
