        ...
        foreach ($_POST['months'] as $monthKey){
            ...
            if(isset($_POST['amount'][$typeKey][$monthKey])){
                ...
                $feeAmount = $_SESSION['amg_advanced_fee']['amount'][$stuid][$typeKey][$monthKey];
                    ...
                    if(isset($_POST['discount_vals'][$typeKey][$monthKey])){
                        //$discount = $_POST['discounts'][$typeKey][$monthKey];
                        $discount =  $_POST['discount_vals'][$typeKey][$monthKey];
                    }
                    else{
                        $discount = 0;
                    }
    ...
    <div class="body">
        ...
        <form action="" method="get">
                ...
                <div align="center">
                    ...
                    <div class="row-fluid">
                       <!-- <div class="span4"><label class="fonts"><?php /*$tool->trans("fee_type") */?></label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if(isset($paidData[$feeStructure['type_id']][$year][$month])){
                               ...
                               echo $fees . '<input type="checkbox" value="'.$fees.'" name="amount['.$feeStructure['type_id'].']['.$dateVal.']" rel="'.$amount.'">';
                               echo '<input type="number" name="discount_vals['.$feeStructure['type_id'].']['.$dateVal.']" placeholder="discount" style="width:70px;" />';
