...
if(isset($_GET['cancel'])==1){
    ...
    $session = isset($_GET['session']) ? $tool->GetInt($_GET['session']) : 0;
    if(empty($invoiceId)){
    ...
    if(empty($session)){
        echo $tool->Message("alert","Please select session");
        exit;
    }
    ...
    Tools::Redir("fees","editidhistory&_chk=1&student_id=".$studentId."&session=".$session,"","");
    ...
    <div class="body">
        ...
        <form action="" method="get">
                ...
                <div align="center">
                    ...
                    <div class="row-fluid">
                        <div class="span4"><label class="fonts"><?php $tool->trans("session") ?></label><?php echo $tpl->getAllSession() ?></div>
                            <div class="span4"><label class="fonts"><?php $tool->trans("id") ?></label><input value="<?php if(isset($_GET['student_id'])) echo $_GET['student_id'] ?>" type="text" name="student_id" id="student_id"/></div>

                            <div class="span4"><button type="submit" class="btn btn-small" style="margin-bottom:10px;"><?php $tool->trans("search") ?></button></div>
        ...
        <div id="printReady">
                    ...
                    $fsData = $fee->getIdHistoryEdit($id,$session);
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    ?>
                    <!--<tr>
                        <td colspan="7" style="text-align: center" class="alert alert-success">
                    ...
                    <tr>
                        ...
                        ?>
                            <td<?php echo $rowSpanString ?> style="text-align: center; vertical-align: middle">
                                ...
                                <br />
                                    <a style="color: red" href="<?php $tool->getUrl() ?>?menu=fees&page=editidhistory&cancel=1&id=<?php echo $rowFee['invoice_db_id'] ?>&student=<?php echo $id ?>&session=<?php echo $session ?>">Cancel</a>
