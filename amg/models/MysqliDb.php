<?php
require_once __DIR__ . DIRECTORY_SEPARATOR . "AmgLog.php";
class MysqliDb
{
    ...
    public function log_db_errors($error, $query)
    {
        ...
        //file_put_contents(__DIR__ . DIRECTORY_SEPARATOR . date("d-m-Y").".txt",$message);
    }
    ...
    public function __construct()
    {
        ...
        try {
            $this->link = new mysqli(DB_HOST, DB_USER, DB_PASS, DB_NAME,3306);
     ...
     *
     */
    public function insert_multi($table, $columns = array(), $records = array(), $duplicate = true)
    {
        self::$counter++;
        ...
        if ($duplicate) {
            $sql .= " ON DUPLICATE KEY UPDATE updated_user_id = " . Tools::getUserId() . ", updated='" . date("Y-m-d H:i:s") . "'";
        }
